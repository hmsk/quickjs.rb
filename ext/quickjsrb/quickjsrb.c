...
static VALUE vm_m_initialize(int argc, VALUE *argv, VALUE r_self)
{
  ...
  {
    JSValue j_polyfillFileResult = run_bytecode_release_gvl(data, bytecode_load_job_run, &qjsc_polyfill_file_min, qjsc_polyfill_file_min_size, false);
  ...
  {
    JSValue j_polyfillEncodingResult = run_bytecode_release_gvl(data, bytecode_load_job_run, &qjsc_polyfill_encoding_min, qjsc_polyfill_encoding_min_size, false);
  ...
  {
    JSValue j_polyfillUrlResult = run_bytecode_release_gvl(data, bytecode_load_job_run, &qjsc_polyfill_url_min, qjsc_polyfill_url_min_size, false);
