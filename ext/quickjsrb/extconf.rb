...
create_makefile('quickjs/quickjsrb') do |conf|
  conf << "QJS_LIB_OBJS= quickjs.o libregexp.o libunicode.o cutils.o quickjs-libc.o libbf.o

POLYFILL_OPTS=-fno-string-normalize -fno-typedarray \
	-fno-typedarray -fno-eval -fno-proxy \
	-fno-module-loader -fno-bigint

qjsc: qjsc.o $(QJS_LIB_OBJS)
	$(Q) $(CC) $(DLDFLAGS) $(CFLAGS) -o $@ $^ -lm
